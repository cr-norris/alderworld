...
(function(factory) {
	...
	$.Unslider = function(context, options) {
		...
		self.defaults = {
			...
			arrows: {
				prev: '<a class="' + self._ + '-arrow prev"><i class="fas fa-chevron-left"></a>',
				next: '<a class="' + self._ + '-arrow next"><i class="fas fa-chevron-right"></a>'
			},
		...
		self.init = function(options) {
			...
			//  Our elements
			self.$container = self.$context.find(self.options.selectors.container).addClass(self.prefix + 'wrap row');
